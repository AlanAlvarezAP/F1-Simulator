...
public:
	...
	static Car* BuildCarScene(World* &mundito) {
		const char* path = "E:/LabCompiler2026_I_CG/glfw-master/OwnProjects/F1-Mclaren-Camaras/models/F1-Mclaren_3.obj";
	...
	static Circuit* BuildCircuitScene(World* &mundito) {
		const char* path = "E:/LabCompiler2026_I_CG/glfw-master/OwnProjects/F1-Mclaren-Camaras/circuit/circuit.obj";
